...
//       description: "Custom designed sneakers with neon accents",
//       image: "👟",
//       color: "from-cyan-500 to-blue-500",
//       price: 129.99,
//       quantity: 1,
//       customization: "Blue accents, Glow in dark sole"
//     },
//     {
//       id: 2,
//       name: "Urban Classic Boot",
//       description: "Leather boots with custom stitching",
//       image: "🥾",
//       color: "from-gray-700 to-gray-900",
//       price: 189.99,
//       quantity: 1,
//       customization: "Brown leather, Gold stitching"
//     },
//     {
//       id: 3,
//       name: "Summer Sandal Deluxe",
//       description: "Handcrafted leather sandals",
//       image: "👡",
//       color: "from-orange-400 to-yellow-400",
//       price: 89.99,
//       quantity: 2,
//       customization: "Tan leather, Rubber sole"
//     }
//   ]);
...
//                         <div className={`w-32 h-32 rounded-xl bg-gradient-to-br ${item.color} flex items-center justify-center text-6xl shadow-lg`}>
//                           {item.image}
//                         </div>
//                       </div>
                  ...
                  {cartItems.map((item, index) => (
                    ...
                    >
                      <div className="flex flex-col md:flex-row gap-6">
                        {/* Product Image */}
                        <div className="flex-shrink-0">
                          <div className={`w-32 h-32 rounded-xl bg-gradient-to-br ${item.color || 'from-blue-500 to-purple-500'} flex items-center justify-center text-6xl shadow-lg`}>
                            {item.image || '👟'}
                          </div>
                        </div>
